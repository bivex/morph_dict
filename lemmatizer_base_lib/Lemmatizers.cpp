...
CLemmatizerSpanish::CLemmatizerSpanish() : CLemmatizer(morphSpanish)
{
};
...
CLemmatizerHungarian::CLemmatizerHungarian() : CLemmatizer(morphHungarian)
{
};
...
CLemmatizerFinnish::CLemmatizerFinnish() : CLemmatizer(morphFinnish)
{
};
