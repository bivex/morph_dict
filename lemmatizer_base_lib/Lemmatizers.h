...
class CLemmatizerFrench : public CLemmatizer {
public:
    CLemmatizerFrench();
...
class CLemmatizerItalian : public CLemmatizer {
public:
    CLemmatizerItalian();
...
class CLemmatizerPolish : public CLemmatizer {
public:
    CLemmatizerPolish();
    virtual ~CLemmatizerPolish() {};
};

class CLemmatizerLatin : public CLemmatizer {
public:
    CLemmatizerLatin();
    virtual ~CLemmatizerLatin() {};
};
