...
extern std::string& StripHungarianAccents(std::string& s_utf8);
extern std::string& StripPolishAccents(std::string& s_utf8);
...
extern bool CheckSpanishUtf8(const std::string& s);
extern bool CheckPortugueseUtf8(const std::string& s);
...
extern bool IsUnicodeUpperSpanishVowel(uint32_t u);
extern bool IsUnicodeUpperPortugueseVowel(uint32_t u);
